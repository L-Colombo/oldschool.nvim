...
oldschool.groups = {
    ...
    Question = { fg = p.white, },
    Search = { fg = p.white, bg = p.medium_green },
    ...
    Visual = { fg = p.white, bg = p.medium_green },
    VisualNOS = { fg = p.white, bg = p.medium_green },
    WarningMSG = { fg = p.red, },
...
oldschool.setup = function()
    vim.cmd.hi("clear")
    vim.g.colors_name = "oldschool"
    vim.o.termguicolors = true

    for group, opts in pairs(oldschool.groups) do
